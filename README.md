...
```
Download and extract protoc-3.10.1-win64.zip from https://github.com/protocolbuffers/protobuf/releases using Protocol Buffers v3.10.1. Go into bin and copy the protoc file into: c:\users\owner\anaconda3\lib\site-packages.

Then copy and paste the following command into the command line and press Enter: (may not find protoc in which case use c:\users\owner\anaconda3\lib\site-packages\protoc --python_out. etc... )
```
